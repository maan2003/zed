...
pub(crate) fn zed_default_dark() -> Theme {
    ...
    Theme {
        ...
        styles: ThemeStyles {
            ...
            colors: ThemeColors {
                border: hsla(225. / 360., 13. / 100., 12. / 100., 1.).into(),
                border_variant: hsla(228. / 360., 8. / 100., 25. / 100., 1.).into(),
                border_focused: hsla(223. / 360., 78. / 100., 65. / 100., 1.).into(),
                border_selected: hsla(222.6 / 360., 77.5 / 100., 65.1 / 100., 1.0).into(),
                border_transparent: SystemColors::default().transparent,
                border_disabled: hsla(222.0 / 360., 11.6 / 100., 33.7 / 100., 1.0).into(),
                elevated_surface_background: elevated_surface.into(),
                surface_background: bg.into(),
                background: bg.into(),
                element_background: hsla(223.0 / 360., 13. / 100., 21. / 100., 1.0).into(),
                element_hover: hover.into(),
                element_active: hsla(220.0 / 360., 11.8 / 100., 20.0 / 100., 1.0).into(),
                element_selected: hsla(224.0 / 360., 11.3 / 100., 26.1 / 100., 1.0).into(),
                element_disabled: SystemColors::default().transparent,
                element_selection_background: player.local().selection.alpha(0.25),
                drop_target_background: hsla(220.0 / 360., 8.3 / 100., 21.4 / 100., 1.0).into(),
                drop_target_border: hsla(221. / 360., 11. / 100., 86. / 100., 1.0).into(),
                ghost_element_background: SystemColors::default().transparent,
                ghost_element_hover: hover.into(),
                ghost_element_active: hsla(220.0 / 360., 11.8 / 100., 20.0 / 100., 1.0).into(),
                ghost_element_selected: hsla(224.0 / 360., 11.3 / 100., 26.1 / 100., 1.0).into(),
                ghost_element_disabled: SystemColors::default().transparent,
                text: hsla(221. / 360., 11. / 100., 86. / 100., 1.0).into(),
                text_muted: hsla(218.0 / 360., 7. / 100., 46. / 100., 1.0).into(),
                text_placeholder: hsla(220.0 / 360., 6.6 / 100., 44.5 / 100., 1.0).into(),
                text_disabled: hsla(220.0 / 360., 6.6 / 100., 44.5 / 100., 1.0).into(),
                text_accent: hsla(222.6 / 360., 77.5 / 100., 65.1 / 100., 1.0).into(),
                icon: hsla(222.9 / 360., 9.9 / 100., 86.1 / 100., 1.0).into(),
                icon_muted: hsla(220.0 / 360., 12.1 / 100., 66.1 / 100., 1.0).into(),
                icon_disabled: hsla(220.0 / 360., 6.4 / 100., 45.7 / 100., 1.0).into(),
                icon_placeholder: hsla(220.0 / 360., 6.4 / 100., 45.7 / 100., 1.0).into(),
                icon_accent: blue.into(),
                debugger_accent: red.into(),
                status_bar_background: bg.into(),
                title_bar_background: bg.into(),
                title_bar_inactive_background: bg.into(),
                toolbar_background: editor.into(),
                tab_bar_background: bg.into(),
                tab_inactive_background: bg.into(),
                tab_active_background: editor.into(),
                search_match_background: bg.into(),
                search_active_match_background: bg.into(),

                editor_background: editor.into(),
                editor_gutter_background: editor.into(),
                editor_subheader_background: bg.into(),
                ...
                .into(),
                editor_line_number: hsla(222.0 / 360., 11.5 / 100., 34.1 / 100., 1.0).into(),
                editor_active_line_number: hsla(216.0 / 360., 5.9 / 100., 49.6 / 100., 1.0).into(),
                editor_hover_line_number: hsla(216.0 / 360., 5.9 / 100., 56.7 / 100., 1.0).into(),
                editor_invisible: hsla(222.0 / 360., 11.5 / 100., 34.1 / 100., 1.0).into(),
                editor_wrap_guide: hsla(228. / 360., 8. / 100., 25. / 100., 1.).into(),
                editor_active_wrap_guide: hsla(228. / 360., 8. / 100., 25. / 100., 1.).into(),
                editor_indent_guide: hsla(228. / 360., 8. / 100., 25. / 100., 1.).into(),
                editor_indent_guide_active: hsla(225. / 360., 13. / 100., 12. / 100., 1.).into(),
                ...
                .into(),
                editor_document_highlight_write_background: gpui::red().into(),
                editor_document_highlight_bracket_background: gpui::green().into(),
                editor_diff_hunk_added_background: ADDED_COLOR.opacity(0.12).into(),
                editor_diff_hunk_added_hollow_background: ADDED_COLOR.opacity(0.06).into(),
                editor_diff_hunk_added_hollow_border: ADDED_COLOR.opacity(0.36).into(),
                editor_diff_hunk_deleted_background: REMOVED_COLOR.opacity(0.12).into(),
                editor_diff_hunk_deleted_hollow_background: REMOVED_COLOR.opacity(0.06).into(),
                editor_diff_hunk_deleted_hollow_border: REMOVED_COLOR.opacity(0.36).into(),

                terminal_background: bg.into(),
                ...
                panel_background: bg.into(),
                panel_focused_border: blue.into(),
                panel_indent_guide: hsla(228. / 360., 8. / 100., 25. / 100., 1.).into(),
                panel_indent_guide_hover: hsla(225. / 360., 13. / 100., 12. / 100., 1.).into(),
                panel_indent_guide_active: hsla(225. / 360., 13. / 100., 12. / 100., 1.).into(),
                panel_overlay_background: bg.into(),
                panel_overlay_hover: hover.into(),
                pane_focused_border: blue.into(),
                pane_group_border: hsla(225. / 360., 13. / 100., 12. / 100., 1.).into(),
                scrollbar_thumb_background: gpui::transparent_black().into(),
                scrollbar_thumb_hover_background: hover.into(),
                ...
                .into(),
                scrollbar_thumb_border: hsla(228. / 360., 8. / 100., 25. / 100., 1.).into(),
                scrollbar_track_background: gpui::transparent_black().into(),
                scrollbar_track_border: hsla(228. / 360., 8. / 100., 25. / 100., 1.).into(),
                minimap_thumb_background: hsla(225.0 / 360., 11.8 / 100., 26.7 / 100., 0.7).into(),
                ...
                version_control_modified: MODIFIED_COLOR.into(),
                version_control_renamed: MODIFIED_COLOR.into(),
                version_control_conflict: crate::orange().light().step_12(),
                version_control_ignored: crate::gray().light().step_12(),
                version_control_word_added: WORD_ADDED_COLOR.into(),
                version_control_word_deleted: WORD_DELETED_COLOR.into(),
                ...
                vim_yank_background: hsla(207.8 / 360., 81. / 100., 66. / 100., 0.2).into(),
                vim_helix_jump_label_foreground: red.into(),
            ...
            status: StatusColors {
                conflict: yellow.into(),
                conflict_background: yellow.into(),
                conflict_border: yellow.into(),
                created: green.into(),
                created_background: green.into(),
                created_border: green.into(),
                deleted: red.into(),
                deleted_background: red.into(),
                deleted_border: red.into(),
                error: red.into(),
                error_background: red.into(),
                error_border: red.into(),
                hidden: gray.into(),
                hidden_background: gray.into(),
                hidden_border: gray.into(),
                hint: blue.into(),
                hint_background: blue.into(),
                hint_border: blue.into(),
                ignored: gray.into(),
                ignored_background: gray.into(),
                ignored_border: gray.into(),
                info: blue.into(),
                info_background: blue.into(),
                info_border: blue.into(),
                modified: yellow.into(),
                modified_background: yellow.into(),
                modified_border: yellow.into(),
                predictive: gray.into(),
                predictive_background: gray.into(),
                predictive_border: gray.into(),
                renamed: blue.into(),
                renamed_background: blue.into(),
                renamed_border: blue.into(),
                success: green.into(),
                success_background: green.into(),
                success_border: green.into(),
                unreachable: gray.into(),
                unreachable_background: gray.into(),
                unreachable_border: gray.into(),
                warning: yellow.into(),
                warning_background: yellow.into(),
                warning_border: yellow.into(),
            },
            player,
